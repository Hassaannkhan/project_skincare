    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uname', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=30)),
                ('email', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=30, unique=True)),
                ('age', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=50)),
                ('skintype', models.CharField(db_collation='SQL_Latin1_General_CP1_CI_AS', max_length=50)),
            ],
            options={
